...
echo 'net.netfilter.nf_conntrack_max = 131072' >>package/base-files/files/etc/sysctl.conf
...
echo '' >>package/base-files/files/etc/sysctl.conf
echo 'net.ipv4.tcp_rmem = 4096 131072 16777216' >>package/base-files/files/etc/sysctl.conf
echo 'net.ipv4.tcp_wmem = 4096 131072 16777216' >>package/base-files/files/etc/sysctl.conf
...
echo '' >>package/base-files/files/etc/sysctl.conf
echo 'net.core.somaxconn = 10240' >>package/base-files/files/etc/sysctl.conf
